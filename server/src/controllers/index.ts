import SettingAppController from './app/setting';
import SlugModuleController from './modules/slug';
import AttributeModuleController from './modules/attribute';
import TemplateModuleController from './modules/template';
